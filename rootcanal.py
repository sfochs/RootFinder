...
def main():
    ...
    suffixes = "arian ian acy al ance ence dom er or ism ist ity ty ment ness ship sion tion ate en ify fy ise izeable ible al esque ful ic icalious ous ish ive less ly ward wards wise eer er ion ity ment ness or sion ship th able ible al ant ary ic ious ous ive less y ed en er ing ward wise atic ten s "
    while run == 1:
